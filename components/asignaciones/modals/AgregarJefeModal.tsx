...
export function AgregarJefeModal({
  open,
  onOpenChange,
  recintoId,
  recintoNombre,
        ...
        <div className="space-y-4 pt-2">
          ...
          <div className="flex gap-6 pt-2">
            <div className="flex items-center gap-2">
              ...
              />
              <Label htmlFor="jefe-whatsapp" className="text-sm cursor-pointer">
                En grupo WhatsApp
              </Label>
            </div>
            <div className="flex items-center gap-2">
              ...
              />
              <Label htmlFor="jefe-carnet" className="text-sm cursor-pointer">
